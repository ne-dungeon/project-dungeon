...
// *theme, *startRoom, *doors, *difficultyDepth, *minions, *miniBosses, **levelBoss, *puzzle, *goesDown, **treasure, coordinates
    
    // public static GameObject Generate(RoomDetails details) {
